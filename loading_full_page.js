  ...
  const ResourceLoader = {
    ...
    createLoadingScreen: function() {
      ...
      style.textContent = `
        ...
        body.loading #${this.loadingScreenId} {
          visibility: visible;
        }
      `;
    ...
    // Method to show the loading screen over the entire page
    showLoadingScreen: function() {
      document.body.classList.add('loading'); // Hide all elements except the loading screen
    },

    // Method to hide the loading screen and show the content
    hideLoadingScreen: function() {
      if (this.activeRequests === 0) {
        document.body.classList.remove('loading'); // Show the entire page content
      }
    },
